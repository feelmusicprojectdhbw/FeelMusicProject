...
public class FeelMusic_Servlet extends HttpServlet {
	...
	/*private void dump(Database db2) throws IllegalAccessException, ClassNotFoundException, InstantiationException, SQLException {
		
		
		try { 
			db.getConnection().createStatement().execute("DROP TABLE albums");
		} catch (SQLException e) { 
        	if (!e.getSQLState().equals("proper SQL-state for table does not exist")) {}else{throw e;} 
        } 
		...
		db.getConnection().createStatement().execute("INSERT INTO albums (name, releasedate) VALUES\r\n" + 
				"	('Single', 0)");
		try {
		...
		db.getConnection().createStatement().execute("INSERT INTO artists (name, link) VALUES\r\n" + 
				"	('non', NULL),\r\n" + 
				"	('Wildstylez', NULL),\r\n" + 
				"	('Sound Rush', NULL),\r\n" + 
				"	('Ruby Prophet', NULL),\r\n" + 
		...
		db.getConnection().createStatement().execute("INSERT INTO feelings (name) VALUES\r\n" + 
				"	( 'angry'),\r\n" + 
				"	( 'anxious'),\r\n" + 
				"	( 'brave'),\r\n" + 
				"	('courageous'),\r\n" + 
		...
		db.getConnection().createStatement().execute("INSERT INTO genres (name, parent) VALUES\r\n" + 
		...
		db.getConnection().createStatement().execute("INSERT INTO songs (releasedate, name, artist, album, genre, label, language, yt_link, sf_link, sc_link) VALUES\r\n" + 
		...
		try {
			db.getConnection().createStatement().execute("DROP TABLE  style");
		} catch (SQLException e) { 
        	if (!e.getSQLState().equals("proper SQL-state for table does not exist")) {}else{throw e;} 
        } 
		...
		db.getConnection().createStatement().execute("INSERT INTO style (name) VALUES\r\n" + 
				"	('Electronic'),\r\n" + 
				"	('Melodic'),\r\n" + 
				"	('Instrumental'),\r\n" + 
				"	('Intro'),	\r\n" + 
		...
		db.getConnection().createStatement().execute("INSERT INTO usertype (name) VALUES\r\n" + 
				"	('Administrator'),\r\n" + 
				"	('User')");
		try {
		...
		db.getConnection().createStatement().execute("CREATE TABLE z_artist_label (\r\n" + 
		...
		db.getConnection().createStatement().execute("CREATE TABLE z_feeling_song (\r\n" + 
		...
		db.getConnection().createStatement().execute("INSERT INTO z_feeling_song (feeling, song, upvoted, downvoted) VALUES\r\n" + 
				"	(1, 1, 1, 0),\r\n" + 
				"	(1, 2, 1, 0),\r\n" + 
				"	(1, 3, 1, 0),\r\n" + 
				"	(3, 1, 1, 0),\r\n" + 
		...
		db.getConnection().createStatement().execute("INSERT INTO z_genre_style (genre, style) VALUES\r\n" + 
				"	(1, 1),\r\n" + 
				"	(2, 1),\r\n" + 
				"	(2, 14),\r\n" + 
				"	(3, 1),\r\n" + 
		...
		try{
        	...
        	if (!e.getSQLState().equals("proper SQL-state for table does not exist")) {}else{} 
        } 
		db.getConnection().createStatement().execute("CREATE TABLE z_playlist_songs (\r\n" + 
		...
		db.getConnection().createStatement().execute("CREATE TABLE z_song_co_artist (\r\n" + 
		...
		db.getConnection().createStatement().execute("INSERT INTO z_song_style (song, style) VALUES\r\n" + 
				"	(1, 1),\r\n" + 
				"	(1, 2),\r\n" + 
				"	(1, 14),\r\n" + 
				"	(2, 1),\r\n" + 
		...
		db.getConnection().createStatement().execute("CREATE TABLE z_user_voted_songfeeling (\r\n" + 
				"  userid int  NOT NULL DEFAULT 0,\r\n" + 
				"  song bigint  NOT NULL DEFAULT 0,\r\n" + 
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			for(Song n : db.getPlaylistcreationSongs(new int[] {20190000, 20200000}, new int[] {2}, new int[] {3}, new int[]{1, 2, 4}, null, null, null, new int[]{5}, null)) {
